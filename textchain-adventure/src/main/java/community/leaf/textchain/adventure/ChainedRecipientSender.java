...
/**
 * Sends components to a recipient by first converting it to an audience.
 *
 * @param <R>   recipient type
 * @param <S>   self-returning subtype (for method chaining)
 */
...
public interface ChainedRecipientSender<R, S extends ChainedRecipientSender<R, S>> extends ChainedAudienceSender<S>
{
    ...
    /**
     * Converts into a component message and sends it to the provided recipient.
     *
    ...
    /**
     * Converts into a component message and sends it to the provided recipient, identified by the provided identity.
     *
     * @param recipient     the recipient to receive components
     * @param source        the identity from whom the components originate
     *
     * @return self (for method chaining)
    ...
    /**
     * Converts into a component message and sends it to the provided recipient, identified by the source's identity.
     *
     * @param recipient     the recipient to receive components
     * @param source        the identifiable source from whom the components originate
     *
     * @return self (for method chaining)
    ...
    /**
     * Converts into a component action bar and sends it to the provided recipient.
     *
     * @param recipient     the recipient to receive components
     *
     * @return self (for method chaining)
