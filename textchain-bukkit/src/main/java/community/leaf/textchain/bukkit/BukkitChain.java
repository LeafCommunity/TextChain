...
public abstract class BukkitChain<C extends BukkitChain<C>> extends AbstractChain<C>
    implements AdventureSource<BukkitAudiences>, ChainedRecipientSender<CommandSender, C>
{
    private final BukkitAudiences audiences;
    
    public BukkitChain(LinearTextComponentBuilderImpl builder, BukkitAudiences audiences)
    {
        super(builder);
